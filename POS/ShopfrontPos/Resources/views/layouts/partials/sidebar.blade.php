<div class="sidebar-wrapper sidebar-theme">
  <nav id="sidebar">
    ...
    <ul class="list-unstyled menu-categories" id="accordionExample">
      ...
      <li class="menu">
        <a href="{{ route('shopfrontpos.dashboard', ['tenant' => $tenantId]) }}"
           aria-expanded="true"
           class="dropdown-toggle @if(request()->routeIs('shopfrontpos.dashboard')) active @endif">
          <div>
      ...
      {{-- Store Users --}}
      <li class="menu">
        <a href="{{ route('shopfrontpos.posusers', ['tenant' => $tenantId]) }}"
           aria-expanded="false"
           class="dropdown-toggle @if(request()->routeIs('shopfrontpos.posusers')) active @endif">
          <div>
            <svg class="nav-icon bi bi-speedometer" width="24" height="24" fill="currentColor">
              <use xlink:href="#speedometer"></use>
            </svg>
      ...
      {{-- Roles --}}
      <li class="menu">
        <a href="{{ route('shopfrontpos.roles', ['tenant' => $tenantId]) }}"
           aria-expanded="false"
           class="dropdown-toggle @if(request()->routeIs('shopfrontpos.roles')) active @endif">
          <div>
            <svg class="nav-icon bi bi-speedometer" width="24" height="24" fill="currentColor">
              <use xlink:href="#speedometer"></use>
            </svg>
